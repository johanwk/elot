...
*** TODO replace with new function ~elot-build-slurp~ and friends, see [[file:elot-tangling.org::*New implementation of ~elot-slurp~ for label display and lookup][New implementation of ~elot-slurp~ for label display and lookup]]
#+name: src-slurp
