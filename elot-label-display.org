...
#+begin_src emacs-lisp
  ...
  Candidates are selected according to `elot-label-lookup-scope'
  (default `both').  `\\[universal-argument]' overrides to `local',
  `\\[universal-argument] \\[universal-argument]' to `external'."
    (interactive "P")
