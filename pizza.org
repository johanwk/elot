...
#+date: WIP (version of 2024-04-02 02:35)
...
| class                                                           | label           |
|-----------------------------------------------------------------+-----------------|
| http://www.co-ode.org/ontologies/pizza/pizza.owl#ValuePartition | ValuePartition  |
| http://www.co-ode.org/ontologies/pizza/pizza.owl#ValuePartition | ValuePartition  |
| http://www.co-ode.org/ontologies/pizza/pizza.owl#ValuePartition | ValorDaParticao |
| http://www.co-ode.org/ontologies/pizza/pizza.owl#DomainConcept  | DomainThing     |
| http://www.co-ode.org/ontologies/pizza/pizza.owl#DomainConcept  | DomainConcept   |
*** construct query
#+name: pizza-construct
#+begin_src sparql :url "pizza.omn" :format ttl :wrap "src ttl" :cache yes
...
#+RESULTS[47d2e64857e1188a22ed23df90f4dab0f1e525f5]: pizza-construct
#+begin_src ttl
@prefix coo:   <http://www.co-ode.org/ontologies/> .
...
pizza:DomainConcept  rdfs:label  "DomainConcept" , "DomainThing"@en .

pizza:ValuePartition  rdfs:label  "ValorDaParticao"@pt , "ValuePartition" , "ValuePartition"@en .
#+end_src

** rdfpuml diagram
Note the use of quotes around the Turtle block name in =ttlblock=.
#+call: rdfpuml-block(ttlblock="pizza-construct", prefixes=ttl-prefixes)

#+RESULTS:
[[file:./images/pizza-construct.png]]
** Prefixes
