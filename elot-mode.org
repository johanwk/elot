...
#+begin_src emacs-lisp
  ...
  (easy-menu-define elot-menu elot-mode-map
    ...
    '("ELOT"
      ...
      ["Export to OWL (Tangle)" org-babel-tangle t]
      ...
      ["Insert Primitive Class template" (lambda () (interactive) (outline-next-heading) (tempo-template-elot-class-iof-primitive))
       :active (fboundp 'tempo-template-elot-class-iof-primitive)]
      ["Insert Defined Class template" (lambda () (interactive) (outline-next-heading) (tempo-template-elot-class-iof-defined))
       :active (fboundp 'tempo-template-elot-class-iof-defined)]
      ["Insert Property template" (lambda () (interactive) (outline-next-heading) (tempo-template-elot-property-iof))
       :active (fboundp 'tempo-template-elot-property-iof)]
      "---"
      ...
      "---"
      ["Insert Table of Resources" tempo-template-elot-table-of-resources :active (fboundp 'tempo-template-elot-table-of-resources)]
...
#+begin_src emacs-lisp
  (defun elot-mode--add-hooks ()
    ...
    ;; Pre-tangle: remember source file and update hierarchy
    (add-hook 'org-babel-pre-tangle-hook #'elot--remember-org-source nil t)
    (add-hook 'org-babel-pre-tangle-hook #'elot-update-headline-hierarchy nil t)
  ...
  (defun elot-mode--remove-hooks ()
    ...
    (remove-hook 'org-babel-pre-tangle-hook #'elot-update-headline-hierarchy t)
