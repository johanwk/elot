...
(provide 'elot)
#+end_src
** Default export SETUPFILE for LaTeX
#+begin_src org :tangle ./elot-package/elot-default-export.org
# allow underscores in export
#+OPTIONS: ^:{}
# number really deep 
#+OPTIONS: H:8 num:8
#+OPTIONS: TOC: 3
#+LATEX_CLASS: book
#+LATEX_CLASS_OPTIONS: [11pt,numbers=noenddot,twoside=false]
#+LaTeX_HEADER: \sloppy
