...
#+begin_src emacs-lisp
  (tempo-define-template "elot-table-of-resources"
   '(
     ...
     "|----+-------+------------|" > n
     "|    |       |            |" > n
     (progn (message "Insert outline with M-x elot-headings-from-table") ""))
   "<otr"
...
#+begin_src emacs-lisp
  (easy-menu-define elot-menu org-mode-map
    ...
    '("ELOT"
      ["Tangle Ontology (Export)" org-babel-tangle t]
      ["Export HTML" (lambda () (interactive) (browse-url-of-file (expand-file-name (org-html-export-to-html)))) t]
      ["Open OWL ontology" elot-open-owl t]
      "---"
      ...
      ["Outline from Table of Resources" elot-headings-from-table t]
      "---"
