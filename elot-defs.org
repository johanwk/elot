...
#+begin_src emacs-lisp :tangle ./elot-package/elot-defaults.el
  ...
  (setq-local
   ...
   (append org-latex-packages-alist '(
     ("" "svg" t)
     "\\lstdefinelanguage{omn}{basicstyle=\\footnotesize\\ttfamily,commentstyle=\\color{gray},frame=single,breaklines=true,breakatwhitespace=true,postbreak=\\mbox{{\\color{gray}\\tiny$\\rightarrow$}},tabsize=2,comment=[l]{\\#},columns=fullflexible,}"
