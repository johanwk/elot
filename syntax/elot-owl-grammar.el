...
(define-peg-ruleset elot-owl-grammar
  ...
  (atomic-expression () (or restriction class-iri "Thing" "Nothing" (and "{" ws individual-list ws "}") (and "(" ows class-expression ows ")")))
  ...
  (data-atomic () (or datatype-restriction datatype-iri (and "{" ws literal-list ws "}") (and "(" ows data-range ows ")")))
