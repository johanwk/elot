  ...
  (let ((gname (or grammar-name "elot-owl-grammar")))
    ...
    (let* ((ast   (peggy--parse-grammar))
      ...
      (with-output-to-string
        ...
        (princ ";; Copyright (C) 2024, 2025, 2026 Johan W. Klüwer\n\n")
        (princ ";; Author: Johan W. Klüwer <johan.w.kluwer@gmail.com>\n")
        (princ ";; URL: https://github.com/johanwk/elot\n")
        (princ ";; SPDX-License-Identifier: GPL-3.0-or-later\n\n")
        (princ ";; This file is not part of GNU Emacs.\n\n")
        (princ ";; This program is free software; you can redistribute it and/or modify\n")
        ...
        (princ ";; (at your option) any later version.\n\n")
        (princ ";; This program is distributed in the hope that it will be useful,\n")
        (princ ";; but WITHOUT ANY WARRANTY; without even the implied warranty of\n")
        (princ ";; MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the\n")
        (princ ";; GNU General Public License for more details.\n\n")
        (princ ";; You should have received a copy of the GNU General Public License\n")
        (princ ";; along with this program.  If not, see <http://www.gnu.org/licenses/>.\n\n")
        (princ ";;; Commentary:\n\n")
        (princ ";; Generated by peggy-to-peg.el from owl-manchester.peggy.\n")
        (princ ";; Do not edit by hand -- edit the .peggy file and run\n")
        (princ ";; \"make grammar && make install\" from the repository root\n")
        (princ ";; to regenerate.\n\n")
        (princ ";;; Code:\n\n")
        (princ "(require 'peg)\n\n")
        ...
        (let ((remaining rules))
          (while remaining
            (princ (peggy--pp-rule (car remaining)))
            (if (cdr remaining)
                (princ "\n")
              ;; Last rule: close ruleset on the same line to keep
              ;; the trailing parens together (MELPA convention).
              (princ ")\n\n"))
