                 ...
                 (let ((key (car y))
                   ...
                   (if meta
                       (concat ind key ": \n"
                               ...
                               "\n"
                               (make-string (+ indent-level 4) ?\s) (string-trim-left (elot-annotation-string-or-uri val)))
                     (concat ind key ": " (string-trim-left (elot-annotation-string-or-uri val))))))
               l
               "\n")))
      ...
      (let ((tangle-target (plist-get ontology-node :tangle-target-omn)))
        (if (not tangle-target)
          ...
          (let* ((prefix-block (elot-omn-prefix-block ontology-node))
                 (resources (elot-omn-resource-declarations (plist-get ontology-node :children)))
                 (omn-content (concat prefix-block "\n\n" resources)))
