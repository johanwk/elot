...
-   [Prerequisites in brief](#org2896ca3)
-   [Installation](#orgf8e9ebb)
    -   [Get Emacs](#orgf5167b3)
    -   [Install ELOT in Emacs](#orgc986a49)
    -   [Install ELOT auxiliaries](#orge999d72)
    -   [NEW: Convert existing OWL files to ELOT format](#orgd425869)
-   [Quick start using ELOT](#org03cd1c8)
    -   [Adding an ontology](#orgf69af5d)
    -   [Adding classes and relations](#orga1dff47)
    -   [Adding annotations](#org6b33d57)
    -   [Querying the ontology](#org0056e60)
    -   [Making a diagram](#orgff54e81)
    -   [Display labels instead of identifiers](#orgb1af67f)
