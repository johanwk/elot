...
-   [Prerequisites in brief](#orgac04adf)
-   [Installation](#org5033d4d)
    -   [Get Emacs](#org76ebf77)
    -   [Install ELOT in Emacs](#org41b66ff)
    -   [Install ELOT auxiliaries](#org65f9263)
    -   [NEW: Convert existing OWL files to ELOT format](#orgc0b3f55)
-   [Quick start using ELOT](#orge820c4b)
    -   [Adding an ontology](#org9eaae8d)
    -   [Adding classes and relations](#org0af008c)
    -   [Adding annotations](#org70d073e)
    -   [Querying the ontology](#org036d1b0)
    -   [Making a diagram](#orgb964338)
    -   [Display labels instead of identifiers](#org3c223fb)
