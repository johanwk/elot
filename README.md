...
-   [Prerequisites in brief](#org703bc72)
-   [Installation](#org57cf459)
    -   [Get Emacs](#orgb86ebcc)
    -   [Install ELOT in Emacs](#orgeafad5b)
    -   [Install ELOT auxiliaries](#org2e2bd6d)
    -   [NEW: Convert existing OWL files to ELOT format](#orga0325ef)
-   [Quick start using ELOT](#org5e55f24)
    -   [Adding an ontology](#org25b518d)
    -   [Adding classes and relations](#org51ea50c)
    -   [Adding annotations](#orgca26b26)
    -   [Querying the ontology](#orge73634a)
    -   [Making a diagram](#orgdd8518b)
    -   [Display labels instead of identifiers](#orgc677878)
