...
-   [Prerequisites in brief](#orga420bb4)
-   [Installation](#org3e8a546)
    -   [Get Emacs](#orgd8e8c29)
    -   [Install ELOT in Emacs](#org84b88ec)
    -   [Install ELOT auxiliaries](#org6193539)
    -   [NEW: Convert existing OWL files to ELOT format](#org16af753)
-   [Quick start using ELOT](#org15d15c6)
    -   [Adding an ontology](#org2157e05)
    -   [Adding classes and relations](#org9abdbf2)
    -   [Adding annotations](#org4c576c6)
    -   [Querying the ontology](#orgc2eca49)
    -   [Making a diagram](#org1e36e5d)
    -   [Display labels instead of identifiers](#orgc55a166)
