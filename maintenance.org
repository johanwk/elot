...
#+date: WIP (version of 2024-04-08 13:58)
...
***** failed state (iof-maint:FailedState)
 ...
 - SubClassOf :: obo:BFO_0000167 some iof-core:MaintainableMaterialItem, inverse (iof-maint:initiates) some iof-maint:FailureEvent
